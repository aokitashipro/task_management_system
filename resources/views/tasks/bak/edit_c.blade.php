...
<form class="form-horizontal" method="post" action="/tasks/tasks/update_c/{{$tasks->id}}">
  ...
  <table class="table table-bordered">
    ...
    <tr>
      ...
      <td><input type="datetime_local" name="対応日" value="{!! date('Y/m/d H:i:s') !!}"></input></td>
    </tr>

    <tr>
      <td class="success">確認者</td>
      <td>
        <select name="確認者" class="form-control">
          <option value="0">確認者を選んで下さい</option>
  ...
  <table class="table table-bordered">
    <tr>
      ...
      <td colspan="3"><textarea name="対応時のメモ" rows="5" class="form-control"></textarea>
      </td>
