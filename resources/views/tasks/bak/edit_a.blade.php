...
<form class="form-horizontal" method="post" action="/tasks/tasks/update_a/{{$tasks->id}}">
  ...
  <table class="table table-bordered">
    ...
    <tr>
      ...
      <td class="success">確認日</td>
      <td><input type="datetime_local" name="確認日" value="{!! date('Y/m/d H:i:s') !!}"></input></td>
    </tr>
    <tr>
      <td class="success">承認者</td>
      <td><select name="承認者" class="form-control">
        <option value="0">承認者を選んで下さい</option>
  ...
  <table class="table table-bordered">
    ...
    <tr>
      ...
      <td colspan="3"><textarea name="確認時のメモ" rows="5" class="form-control"></textarea>
        </td>
    </tr>
    <tr>
