...
<form class="form-horizontal" method="post" action="/tasks/tasks/update_com/{{$tasks->id}}">
  ...
  <table class="table table-bordered">
    ...
    <tr>
      ...
      <td>
        <input type="datetime_local" name="最終確認日" value="{!! date('Y/m/d H:i:s') !!}"></input>
      </td>
    </tr>
  </table>
  ...
  <table class="table table-bordered">
    ...
    <tr>
      ...
      <td colspan="3">{!! nl2br(e( $tasks['承認時のメモ'])) !!}
      </td>
    </tr>
